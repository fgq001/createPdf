...
public class CreatePdfServiceImlp {
	...
	static String qdmbPath = ("E:\\PDFFileTest" + File.separator + "qd(1).pdf");
	 ...
	 static String tempPdf1 = ("E:\\PDFFileTest" + File.separator + CommonUtils.getUUID()
				 + ".pdf");
	 static String expPath1 = "E:\\PDFFileTest" + File.separator + startTime + ".pdf";
...
//		setSimpleText(xxfp.getFphm(), 477.0F, 352.0F, 700.0F, 364.0F, font, over1);
		...
		String kprq = xxfp.getKprq().substring(0, 4) + "  " + xxfp.getKprq().substring(5, 7) + "  "
				+ xxfp.getKprq().substring(8, 10);
		...
		if ((xxfp.getEwmPath() != null) && (!"".equals(xxfp.getEwmPath()))) {
			over1 = over1 == null ? stamp.getOverContent(1) : over1;
			BarcodeQRCode qrcode = new BarcodeQRCode(xxfp.getEwmPath().trim(), 1, 1, null);
			Image qrcodeImage = qrcode.getImage();
			qrcodeImage.setAlignment(1);	
			qrcodeImage.scaleAbsolute(60.0F, 60.0F);
			qrcodeImage.setAbsolutePosition(24.0F, 329.0F);
...
//								over);
			...
			if (isQdfp(xxfp, mxlist)) {
				...
				for (int j = 0; (j < pages) && (j + 1 <= PDFPages); j++) {
					...
					String qdKprq = xxfp.getKprq().substring(0, 4) + "   " + xxfp.getKprq().substring(5, 7) + "   "
							+ xxfp.getKprq().substring(8, 10);
	...
	public static void main(String[] args) throws IOException, DocumentException {
		...
		// String tempPdf = ("E:\\PDFFileTest" + File.separator + CommonUtils.getUUID()
		// + ".pdf");
//		String expPath = "E:\\PDFFileTest" + File.separator + startTime + ".pdf";
