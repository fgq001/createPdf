 ...
 */
public class XmlJxServiceImpl implements XmlJxService {
    @Override
    public void XmlJx(String xmlContent, String tmpPath, String temPath, String endPath, Xxfp xxfp, List<Xxfpmx> xxfpmxList, String pfx, String gif, String password) throws IOException, DocumentException {
