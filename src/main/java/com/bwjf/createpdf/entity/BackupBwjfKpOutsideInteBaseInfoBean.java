 ...
 * @版本 V 1.0
 */
public class BackupBwjfKpOutsideInteBaseInfoBean implements Serializable {
	/**
	 * serialVersionUID
	 */
	 ...
	 * 开票日期年份
	 */
	private String kprqYear;
	/**
	 * 开票日期月份
	 */
	private String kprqMonth;
	...
	public BackupBwjfKpOutsideInteBaseInfoBean(Integer id) {
		this.id = id;
	}
	...
	public BackupBwjfKpOutsideInteBaseInfoBean() {
	}

	public String getKprqYear() {
		return kprqYear;
	}

	public void setKprqYear(String kprqYear) {
		this.kprqYear = kprqYear;
	}

	public String getKprqMonth() {
		return kprqMonth;
	}

	public void setKprqMonth(String kprqMonth) {
		this.kprqMonth = kprqMonth;
	}
